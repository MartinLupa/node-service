...
var METRICS_PORT = (_a = process.env.METRICS_SERVICE_PORT) !== null && _a !== void 0 ? _a : 9100;
/**
 ...
 */
exports.restResponseTimeHistogram = new prom_client_1.Histogram({
 ...
 */
exports.databaseResponseTimeHistogram = new prom_client_1.Histogram({
...
function startMetricsServer() {
    ...
    app.listen(METRICS_PORT, function () {
        console.info("[metricsServer] started on ".concat(METRICS_PORT));
    });
}
